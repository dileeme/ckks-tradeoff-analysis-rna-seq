...
# ==========================================================
BATCHES = {
    "batch_a": "datasets/d2_batch_a_100.csv",
    "batch_b": "datasets/d2_batch_b_400.csv",
    "batch_c": "datasets/d2_batch_c_1129.csv",
}
OUTPUT_DIR = "scoring/dataset2/"
...
def compute_de_scores(df, batch_name):
    ...
    Dataset 2 has one pair only: LUSC vs LUAD.
    """
...
for batch_name, batch_path in BATCHES.items():
    ...
    # Save
    out_path = os.path.join(OUTPUT_DIR, f"d2_de_baseline_{batch_name}.csv")
...
# ==========================================================
print(f"\n{'='*50}")
print("DATASET 2 PLAINTEXT DE BASELINE COMPLETE")
print(f"{'='*50}")
